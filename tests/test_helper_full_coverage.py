...
class TestMergeFolderContent:
    ...
    def test_merge_folder_no_append(self):
        ...
        merge_folder_content(str(src_base), str(dest), append_folder_name=False, clear_dest_folder=True)
...
class TestXorMask:
    ...
    def test_xor_mask_Q_format(self):
        ...
        try:
            ...
            assert result == np.uint64(0b1111100111000011011011111001110011111001110000110110111110011100)
