...
class TestRU10EndToEnd:
    ...
    def test_e2e_basic_binary(self):
        ...
        number_of_chunks = 20
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50, insert_header=True)
        encoder.encode_to_packets()
    ...
    def test_e2e_with_checksum(self):
        ...
        number_of_chunks = 15
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50,
                             insert_header=True, checksum_len_str="I")
        encoder.encode_to_packets()
    ...
    def test_e2e_without_header(self):
        ...
        number_of_chunks = 15
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50, insert_header=False)
        encoder.encode_to_packets()
        ...
        decoder = RU10Decoder(out_dir, use_headerchunk=False, static_number_of_chunks=number_of_chunks)
        decoder.decodeFolder()
        assert decoder is not None
    ...
    def test_e2e_with_xor_by_seed(self):
        ...
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50,
                             insert_header=True, xor_by_seed=True)
        encoder.encode_to_packets()
    ...
    def test_e2e_with_mask_id_false(self):
        ...
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50,
                             insert_header=True, mask_id=False)
        encoder.encode_to_packets()
    ...
    def test_e2e_with_id_spacing(self):
        ...
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50,
                             insert_header=True, id_spacing=5)
        encoder.encode_to_packets()
    ...
    def test_e2e_different_chunk_sizes(self):
        ...
        for chunk_size in [50, 100, 200, 500]:
            # Encode
            number_of_chunks = Encoder.get_number_of_chunks_for_file_with_chunk_size(str(test_file), chunk_size)
            dist = RaptorDistribution(number_of_chunks)
            encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=chunk_size, insert_header=True)
            encoder.encode_to_packets()
    ...
    def test_e2e_large_file(self):
        ...
        number_of_chunks = 50
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=300, insert_header=True)
        encoder.encode_to_packets()
    ...
    def test_e2e_with_error_correction_crc(self):
        ...
        dist = RaptorDistribution(number_of_chunks)
        encoder = RU10Encoder(str(test_file), number_of_chunks, dist, chunk_size=50,
                             insert_header=True, error_correction=crc32)
        encoder.encode_to_packets()
