...
class HeaderChunk:
    ...
    def decode_header_info(self) -> typing.Tuple[int, typing.Union[bytes, str]]:
        ...
        last_chunk_length: int = struct.unpack(
            "<" + self.last_chunk_len_format, bytes(self.data[0:last_chunk_struct_len])
        )[0]
        ...
        file_name: typing.Union[str, bytes] = struct.unpack(
            "<"
            + str(len(data[last_chunk_struct_len + checksum_struct_len : end_of_file_name]))
            + "s",
            data[last_chunk_struct_len + checksum_struct_len : end_of_file_name],
        )[0]
        self.additional_payload = data[
            end_of_file_name:
    ...
    def from_raw_array(
        ...
        packet = Packet(
            raw_array, {0}, total_number_of_chunks=0
